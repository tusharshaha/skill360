  ...
  const courses = [
    {
      ...
      students: 100,
      price: 100,
      image: "https://cdn.10minuteschool.com/images/thumbnails/ielts-live-batch-10-thumbnail.jpg"
    },
    {
    ...
    },
    {
      ...
      students: 150,
      price: 150,
      image: "https://cdn.10minuteschool.com/images/Thumbnails/sohoje_spoken_arbi_16x9.jpg"
    },
  ]
  return (
    <div className="banner">
      <div className="cus-container pt-16 pb-48 md:py-32 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-6">
        ...
        <div className="hidden lg:block lg:w-1/3">
          <Image src="/images/banner-01.png" alt="banner" width={500} height={500} className='size-[600px]'/>
        </div>
        <div className='w-full md:w-1/2 lg:w-1/3 space-y-8'>
